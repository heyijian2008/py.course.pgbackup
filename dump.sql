...
--
-- Name: employees; Type: TABLE; Schema: public; Owner: user1
--
...
ALTER TABLE public.employees OWNER TO user1;

--
-- Data for Name: employees; Type: TABLE DATA; Schema: public; Owner: user1
--
